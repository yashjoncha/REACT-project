...
import image from './New folder/Screenshot 2023-11-09 203538.png';
import imagebig2 from './New folder/Screenshot 2023-11-09 203633.png';
import image1 from './New folder/Screenshot 2023-11-09 203556.png';
...
<div className="image-container-custom">
      <div className="image-wrapper-custom">
        <img src={footbal} alt="Img" />
        <div className="image-content-custom">
          {/* <p>For Him</p> */}
          <button className="shop-button-custom">Footbal</button>
        </div>
      </div>
      <div className="image-wrapper-custom">
        ...
        <div className="image-content-custom">
          {/* <p>For Her</p> */}
          <button className="shop-button-custom">Running</button>
        </div>
      </div>
      <div className="image-wrapper-custom">
        <img src={sportsweaar} alt="Img" />
        <div className="image-content-custom">
          
          <button className="shop-button-custom">Sports Wear</button>
        </div>
      </div>
    </div>
